<h1 align="left">Mohamed Mahdy</h1>
...
<p align="left">Backend-focused full-stack developer. Python/Django/DRF and PostgreSQL, 
React for frontend development when needed. Also works with Flask, MySQL and SQL Server.

Background in business before moving into engineering — useful for building things 
people pay for, not just things that work.

Interested in system design, distributed systems, and scaling backend infrastructure.</p>
...
### AcademyQ
A SaaS platform for academy management featuring role-based access control (RBAC), student and teacher management, attendance tracking, scheduling, multi-language support, subscription management, and online payments.

### Vegist
A professional-grade e-commerce web application for fresh organic produce, built around a multi-actor architecture supporting Customers, Sellers, and Administrators with dedicated workflows and secure access levels.

### Spaxet
A POS and inventory management system built with Flask and SQL Server, supporting inventory tracking, sales, and session management.
